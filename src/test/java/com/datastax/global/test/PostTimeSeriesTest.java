...
public class PostTimeSeriesTest {
	...
	public void postDataPoints() {
		...
		try {
			...
			WebResource webResource = client
					.resource("http://localhost:8080/datastax-global-store/rest/post/datapoints");
	...
	public void getDataPoints() {
		...
		try {
			...
			WebResource webResource = client
					.resource("http://localhost:8080/datastax-global-store/rest/get/datapoints?key=test");
	...
	public void testPutObject(){
		try {
			...
			WebResource webResource = client
					.resource("http://localhost:8080/datastax-global-store/rest/post/object");
	...
	public void testGetObject(){
		try {
			...
			WebResource webResource = client
					.resource("http://localhost:8080/datastax-global-store/rest/get/object?key=test-object");
